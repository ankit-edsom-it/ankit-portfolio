...
export default function Home() {
  return (
    <motion.div initial="hidden" animate="show" variants={stagger}>
      <motion.section
        variants={fadeInUp}
        className="grid md:grid-cols-3 gap-6 items-center mb-16 mt-16"
      >
        <div className="md:col-span-2">
          ...
          <p className="text-slate-600 mt-3 text-lg">
            Software Developer (React) — building scalable UIs & fintech
            integrations.
          </p>
      ...
      <motion.p variants={fadeInUp} className="mb-4">
        📧 itsankit.k27@gmail.com • 📱 8299144486 | 8574998116 • 📍 Pune, Maharashtra
      </motion.p>
    </motion.div>
  );
}
